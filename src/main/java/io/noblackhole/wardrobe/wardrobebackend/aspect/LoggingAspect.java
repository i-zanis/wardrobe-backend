package io.noblackhole.wardrobe.wardrobebackend.aspect;
...
public class LoggingAspect {
  ...
  public void springBeanPointcut() {
    // This is a pointcut, the implementation of the method is in the advices.
  }

  /**
   * Pointcut that matches all Spring beans in the application's main packages.
   */
  @Pointcut("within(io.noblackhole.wardrobe.wardrobebackend..*)" + " || " +
    "within(io.noblackhole.wardrobe.wardrobebackend.service..*)" + " || " +
    "within(io.noblackhole.wardrobe.wardrobebackend.controller..*)")
