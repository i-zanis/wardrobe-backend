...
//
    ...
    static AccountDto createValid() {
        new AccountDto.Builder()
                .withId(200_000_000)
                .withCustomerName("Customer Name 1")
                .withCompanyRegistrationNumber("200_001_000")

                .withMobilePhone("200002000")
                .withLandlinePhone("20000300")
                .withEmail("company1@gmail.com")
                .withRegisteredStreet("Registered Street 1")
                .withRegisteredCity("Registered City 2")
                .withRegisteredCountry("Registered Country 1")
                .withRegisteredCounty("Registered County 1")
                .withRegisteredPostcode("Registered Postcode 1")
                .withTradingStreet("Trading Street 1")
                .withTradingCity("Trading City 1")
                .withTradingCountry("Trading Country 1")
                        .withTradingCounty("Trading County 1")
                                .withTradingPostcode("Training Postcode 1")
                                        .withLegalEntityType("Legal Entity Type 1")
                                                .withOwnership("Ownership 1")
                                                        .withCustomerOwner()
        accountDto.setLegalEntityType(legalEntityType);
        accountDto.setOwnership(ownership);
        accountDto.setCustomerOwner(customerOwner);
        accountDto.setSicCode(sicCode);
        accountDto.setExposure(exposure);
        accountDto.setMarketing(marketing);
        accountDto.setNewsletter(newsletter);
        accountDto.setStocklist(stocklist);
        accountDto.setTitle(title);
        accountDto.setForename(forename);
        accountDto.setMiddleName(middleName);
        accountDto.setLastname(lastname);
        accountDto.setDayOfBirth(dayOfBirth);
        accountDto.setMonthOfBirth(monthOfBirth);
        accountDto.setYearOfBirth(yearOfBirth);
        accountDto.setNationality(nationality);
        accountDto.setRegisteredPremises(registeredPremises);
        accountDto.setRegisteredRoad(registeredRoad);
        accountDto.setTradingPremises(tradingPremises);
        accountDto.setTradingRoad(tradingRoad);
        accountDto.setCreditReportId(creditReportId);
        accountDto.setDateOfLastCreditSearch(dateOfLastCreditSearch);
        accountDto.setCreditReportLink(creditReportLink);
        accountDto.setKycId(kycId);
        accountDto.setAccountClsId(accountClsId);
        accountDto.setAccountZohoId(accountZohoId);
        accountDto.setRecordType(recordType);
        accountDto.setUpdated(updated);
        accountDto.setType(type);
        accountDto.setIntroducer(introducer);
